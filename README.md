...
During this period, I wrote for **CODE Magazine (MP Ediciones)**, one of the most recognized publications for senior programmers in Latin America, and produced technical training materials for **Dattatec.com** (Online Training).

My articles focused on advanced topics in web application development, PHP, XML, Ajax, and emerging web technologies of the 2000s. Each piece combined theoretical depth with practical examples and complete source code.

### 🖋 Selected Articles (CODE Magazine)
- *Windows Applications with PHP (PHP-GTK)*
- *Review: Zend Studio 3.5*
- *XML, the Universal Language* — Cover Article (10 pages)
- *PHP and Multimedia* (GD, JpGraph, and graphics libraries)
- *PHP in Advance: Performance, Security, and Interoperability* — Cover Article (10 pages)
- *PHP and Web Services* (NuSOAP and integration techniques)
- *Advanced Ajax and PHP* (SAJAX and native methods)
- *Fast Forms with HTML_QuickForm and Smarty*
...
- XML fundamentals  
- eCommerce setup (osCommerce)  
- SEO and traffic optimization  
- PHP/MySQL-based tracking systems and CRUD operations  
- File management and dynamic content


 Example Article
- [PHP in Advance: Present and Future — CODE Magazine (Sample PDF)](./articles/PHP_CODE14_SAMPLE.pdf)  
  *Cover article about performance, security, interoperability and the evolution of PHP. Published in CODE Magazine (2005).*
...
Durante este período escribí para **Revista CODE (MP Ediciones)**, una de las publicaciones más reconocidas por programadores senior en Latinoamérica, y desarrollé materiales de capacitación técnica para **Dattatec.com** (Formación Online).

Mis artículos abordaron temas avanzados de desarrollo web, PHP, XML, Ajax y tecnologías emergentes de la web en los años 2000, combinando teoría, práctica y código completo.

### 🖋 Artículos Destacados (Revista CODE)
- *Aplicaciones Windows con PHP (PHP-GTK)*
- *Revisión: Zend Studio 3.5*
- *XML, el lenguaje universal* — Artículo de tapa (10 páginas)
- *PHP y Multimedia* (GD, JpGraph y bibliotecas gráficas)
- *PHP Avanzado: Rendimiento, seguridad e interoperabilidad* — Artículo de tapa (10 páginas)
- *PHP y Web Services* (NuSOAP y tecnologías relacionadas)
- *Ajax y PHP Avanzado* (SAJAX y métodos nativos)
- *Formularios rápidos con HTML_QuickForm y Smarty*
...
- SEO y optimización de tráfico  
- Sistemas de seguimiento con PHP/MySQL  
- Gestión de archivos y contenido dinámico

---

📄 Ejemplo de artículo 

- [PHP en el futuro: presente y futuro — Revista CODE (PDF de muestra)](./articles/PHP_CODE14_SAMPLE.pdf)
